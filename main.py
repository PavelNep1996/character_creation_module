...
# персонажа и возвращает строковое сообщение о проведённой атаке.
...
# персонажа и возвращает строковое сообщение о выполненном блокировании атаки.
...
# запускает цикл тренировки навыков персонажа. В качестве параметров она
# получает введённое игроком имя персонажа и выбранный тип персонажа.
